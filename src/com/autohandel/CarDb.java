...
public class CarDb {
    ...
    private List<Car> generateCarsForSale() {
        ...
        List<String> brands = List.of("Audi", "Mercedes", "Fiat", "Porsche", "Volkswagen", "BMW", "Citroen", "Opel", "Peugeot", "Dacia", "Hyundai", "");
        List<String> colors = List.of("blue", "red", "green", "white", "yellow", "black");
